...
func (m *CardMutation) SetDecimal(d decimal.Decimal) {
	m.decimal = &d
	m.adddecimal = nil
}

// Decimal returns the value of the "decimal" field in the mutation.
func (m *CardMutation) Decimal() (r decimal.Decimal, exists bool) {
	v := m.decimal
	if v == nil {
		return
	}
...
// OldDecimal returns the old "decimal" field's value of the Card entity.
// If the Card object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CardMutation) OldDecimal(ctx context.Context) (v decimal.Decimal, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CardMutation) AddDecimal(d decimal.Decimal) {
	if m.adddecimal != nil {
		*m.adddecimal = m.adddecimal.Add(d)
	} else {
		m.adddecimal = &d
	}
}
...
func (m *CardMutation) AddedDecimal() (r decimal.Decimal, exists bool) {
	v := m.adddecimal
	if v == nil {
		return
	}
...
func (m *CardMutation) ResetDecimal() {
	m.decimal = nil
	m.adddecimal = nil
}
...
func (m *CardMutation) Fields() []string {
	...
	if m.decimal != nil {
		fields = append(fields, card.FieldDecimal)
	}
	return fields
}
