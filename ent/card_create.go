...
func (cc *CardCreate) SetDecimal(d decimal.Decimal) *CardCreate {
	cc.mutation.SetDecimal(d)
	return cc
}
...
func (cc *CardCreate) check() error {
	...
	if _, ok := cc.mutation.Decimal(); !ok {
		return &ValidationError{Name: "decimal", err: errors.New(`ent: missing required field "Card.decimal"`)}
	}
	return nil
}
...
func (cc *CardCreate) createSpec() (*Card, *sqlgraph.CreateSpec) {
	...
	if value, ok := cc.mutation.Decimal(); ok {
